...
█ ▲▲▲▲▲ -_-- -╚═╩═╝╚═╝╚═╝╚═╝╚═╝╚╩═╩╝╚═╝
█████████      «°°°°°°°°°°✧°°°°°°°°°°»
 ██ ██.   {m} ☯︎ {k} ☯︎ {h} ☯︎ {sir} Recode : F3RZSIBER {x}{m} ☯︎ {k} ☯︎ {h} ☯︎ {x}
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
{k}[•]PREMIUM
[•]https://github.com/f3rz-siber
[•]ONANYMOUS✓""")
...
#				A += '\n'+p
	...
	sys.exit(f" [{M}>{P}] gak onok koneksi coeg :v")
